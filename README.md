...
/Users/jessepelzar/Library/Arduino15/packages/esp32/tools/esptool_py/4.5.1/esptool --chip esp32 --port /dev/cu.usbserial-0001 --baud 921600 --before default_reset --after hard_reset write_flash -z --flash_mode dio --flash_freq 80m --flash_size 4MB 

0x1000 /var/folders/n6/5rn7ryg54cx544cbsrvk72s40000gn/T/arduino_build_649544/loomx_lune_legacy_v1.ino.bootloader.bin 

0x8000 /var/folders/n6/5rn7ryg54cx544cbsrvk72s40000gn/T/arduino_build_649544/loomx_lune_legacy_v1.ino.partitions.bin 

0xe000 /Users/jessepelzar/Library/Arduino15/packages/esp32/hardware/esp32/2.0.8/tools/partitions/boot_app0.bin 

0x10000 /var/folders/n6/5rn7ryg54cx544cbsrvk72s40000gn/T/arduino_build_649544/loomx_lune_legacy_v1.ino.bin 
esptool.py v4.5.1
  ...
  "builds": [
    {
      ...
      "improv": false,
      "parts": [
        { "path": "loomx_lune_legacy_v1.ino.bootloader.bin", "offset": 4096 },
        { "path": "loomx_lune_legacy_v1.ino.partitions.bin", "offset": 32768 },
        { "path": "boot_app0.bin", "offset": 57344 },
        { "path": "loomx_lune_legacy_v1.ino.bin", "offset": 65536 }
      ]
    }
  ]
}
