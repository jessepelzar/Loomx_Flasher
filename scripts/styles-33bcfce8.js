        ...
        const i = 1 === t.length
            ...
            : e.reduce(((e, i, o) => e + (t => {
                ...
                if ("number" == typeof t) 
                    return t;
                throw Error(
                    "Value passed to 'css' function must be a 'css' function result: " + t + ". Use" +
                    " 'unsafeCSS' to pass non-literal values, but take care to ensure page security" +
                    "."
                )
            })(i) + t[o + 1]), t[0]);
        return new c(i, t, s)
...
let x = class extends HTMLElement {
    ...
    removeController(t) {
        var e;
        null === (e = this._$ES) || void 0 === e || e.splice(
            this._$ES.indexOf(t) >>> 0,
            1
        )
    }
    _$Eg() {
...
const A = window,
    ...
    B = t => (e, ...i) => ({_$litType$: t, strings: e, values: i}),
    V = B(1),
    j = B(2),
...
class X {
    constructor({
        ...
        const a = t.length - 1,
            s = this.parts,
            [d, c] = Y(t, e);
        if (this.el = X.createElement(d, i), W.currentNode = this.el.content, 2 === e) {
...
function Z(t, e, i = t, o) {
    ...
    return (
        ...
        void 0 === c
            ? d = void 0
            : (d = new c(t), d._$AT(t, i, o)),
        void 0 !== o
            ? (
                null !== (a = (s = i)._$Co) && void 0 !== a
                    ? a
                    : s._$Co = []
            )[o] = d
            : i._$Cl = d
...
class rt extends tt {
    ...
    _$AI(t, e = this) {
        var i;
        if ((
            t = null !== (i = Z(this, t, e, 0)) && void 0 !== i
                ? i
                : K
        ) === G) 
            return;
        ...
        r && this
            .element
            .removeEventListener(this.name, this, o),
        n && this
            .element
            .addEventListener(this.name, this, t),
        this._$AH = t
    }
    handleEvent(t) {
        var e,
        ...
        "function" == typeof this._$AH
            ? this
                ...
                .call(
                    null !== (
                        i = null === (e = this.options) || void 0 === e
                            ? void 0
                            : e.host
                    ) && void 0 !== i
                        ? i
...
class ct extends x {
    ...
    createRenderRoot() {
        ...
        return null !== (t = (e = this.renderOptions).renderBefore) && void 0 !== t || (
...
ct.finalized = !0,
ct._$litElement$ = !0,
null === (st = globalThis.litElementHydrateSupport) || void 0 === st || st.call(
    globalThis,
    {LitElement: ct}
);
...
const pt = t => e => "function" == typeof e
    ...
    ut = (t, e) => "method" === e.kind && e.descriptor && !(
...
const gt = ({finisher: t, descriptor: e}) => (i, o) => {
    var r;
    if (void 0 === o) {
        const o = null !== (r = i.originalKey) && void 0 !== r
                ? r
                : i.key,
            n = null != e
                ? {
            ...
            const o = {
                get() {
                    var e,
                        i;
                    return null !== (
                        i = null === (e = this.renderRoot) || void 0 === e
                            ? void 0
                            : e.querySelector(t)
                    ) && void 0 !== i
                        ? i
            ...
            if (e) {
                ...
                o.get = function () {
                    ...
                    return void 0 === this[e] && (
                        this[e] = null !== (
                            o = null === (i = this.renderRoot) || void 0 === i
                                ? void 0
                                : i.querySelector(t)
                        ) && void 0 !== o
                            ? o
...
function Et(t) {
    const {slot: e, selector: i} = null != t
        ? t
        : {};
    return gt({
        descriptor: o => ({
            get() {
                ...
                const r = "slot" + (
                    ...
                    n = null === (o = this.renderRoot) || void 0 === o
                        ? void 0
                        : o.querySelector(r),
                    a = null != n
                        ? xt(n, t)
...
const $t = (t = window.document) => {
    ...
    Ot = t => {
        ...
        return document
            .body
            .addEventListener("check-if-focused", n),
        i.dispatchEvent(o),
        document
            .body
            .removeEventListener("check-if-focused", n),
        -1 !== r.indexOf(t)
    };
class It extends ct {
    click() {
    ...
    createFoundation() {
        void 0 !== this.mdcFoundation && this
            .mdcFoundation
            .destroy(),
...
var Lt = [
    ...
    zt = function (t) {
        ...
        o.prototype.init = function () {
            ...
            if (this.registerRootHandlers(e), e) {
                ...
                requestAnimationFrame((function () {
                    ...
                    t
                        .adapter
                        .isUnbounded() && (t.adapter.addClass(n), t.layoutInternal())
                }))
            }
        },
        ...
        o.prototype.registerRootHandlers = function (t) {
            ...
            if (t) {
                try {
                    for (var o = r(Lt), n = o.next(); !n.done; n = o.next()) {
                        ...
                        this
                            .adapter
                            .registerInteractionHandler(a, this.activateHandler)
                    }
                } catch (t) {
                    e = {
                        error: t
            ...
            this
                .adapter
                .registerInteractionHandler("focus", this.focusHandler),
            this
                .adapter
                .registerInteractionHandler("blur", this.blurHandler)
        },
        o.prototype.registerDeactivationHandlers = function (t) {
            ...
            if ("keydown" === t.type) 
                this
                    .adapter
                    .registerInteractionHandler("keyup", this.deactivateHandler);
            else 
                try {
                    for (var o = r(Pt), n = o.next(); !n.done; n = o.next()) {
                        ...
                        this
                            .adapter
                            .registerDocumentInteractionHandler(a, this.deactivateHandler)
                    }
                } catch (t) {
                    e = {
                        error: t
        ...
        o.prototype.deregisterRootHandlers = function () {
            ...
            try {
                for (var i = r(Lt), o = i.next(); !o.done; o = i.next()) {
                    ...
                    this
                        .adapter
                        .deregisterInteractionHandler(n, this.activateHandler)
                }
            } catch (e) {
                t = {
                    error: e
            ...
            this
                .adapter
                .deregisterInteractionHandler("focus", this.focusHandler),
            this
                .adapter
                .deregisterInteractionHandler("blur", this.blurHandler),
            this
                .adapter
                .isUnbounded() && this
                .adapter
                .deregisterResizeHandler(this.resizeHandler)
        },
        o.prototype.deregisterDeactivationHandlers = function () {
            ...
            this
                .adapter
                .deregisterInteractionHandler("keyup", this.deactivateHandler);
            try {
                for (var i = r(Pt), o = i.next(); !o.done; o = i.next()) {
                    var n = o.value;
                    this
                        .adapter
                        .deregisterDocumentInteractionHandler(n, this.deactivateHandler)
                }
            } catch (e) {
                t = {
                    error: e
                ...
                if (!i.isActivated) {
                    ...
                    if (!(o && void 0 !== t && o.type !== t.type)) 
                        ...
                        i.wasActivatedByPointer = !i.isProgrammatic && (
                            void 0 !== t && ("mousedown" === t.type || "touchstart" === t.type || "pointerdown" === t.type)
                        ),
                        void 0 !== t && Mt.length > 0 && Mt.some((function (t) {
                            return e
                                .adapter
                                .containsEventTarget(t)
                        }))
                            ? this.resetActivationState()
                            : (
                                void 0 !== t && (Mt.push(t.target), this.registerDeactivationHandlers(t)),
                                i.wasElementMadeActive = this.checkElementMadeActive(t),
                                i.wasElementMadeActive && this.animateActivation(),
                                requestAnimationFrame((function () {
                                    Mt = [],
                                    i.wasElementMadeActive || void 0 === t || " " !== t.key && 32 !== t.keyCode || (
                                        i.wasElementMadeActive = e.checkElementMadeActive(t),
        ...
        o.prototype.checkElementMadeActive = function (t) {
            return void 0 === t || "keydown" !== t.type || this
                .adapter
                .isSurfaceActive()
        },
        o.prototype.animateActivation = function () {
            ...
            this
                .adapter
                .updateCssVariable(i, c),
            this
                .adapter
                .updateCssVariable(r, l),
            clearTimeout(this.activationTimer),
            clearTimeout(this.fgDeactivationRemovalTimer),
        ...
        o.prototype.getFgTranslationCoordinates = function () {
            var t,
                ...
                i = e.activationEvent;
            return t = e.wasActivatedByPointer
                ? function (t, e, i) {
                    if (!t) 
                        return {x: 0, y: 0};
                    var o,
        ...
        o.prototype.runDeactivationUXLogicIfReady = function () {
            var t = this,
                ...
                n = i.isActivated;
            (r || !n) && this.activationAnimationHasEnded && (
                this.rmBoundedActivationClasses(),
        ...
        o.prototype.deactivateImpl = function () {
            ...
            if (e.isActivated) {
                ...
                e.isProgrammatic
                    ...
                    : (this.deregisterDeactivationHandlers(), requestAnimationFrame((function () {
        ...
        o.prototype.layoutInternal = function () {
            ...
            this.maxRadius = this
                ...
                .isUnbounded()
                    ? e
                    : Math.sqrt(Math.pow(t.frame.width, 2) + Math.pow(t.frame.height, 2)) + o.numbers.PADDING;
        ...
        o.prototype.updateLayoutCssVars = function () {
            ...
            this
                .adapter
                .updateCssVariable(e, this.initialSize + "px"),
            this
                .adapter
                .updateCssVariable(n, this.fgScale),
            this
                .adapter
                .isUnbounded() && (
...
const Bt = {
    ...
    Vt = t => (...e) => ({_$litDirective$: t, values: e});
let jt = class {
    constructor(t) {}
    get _$AU() {
        return this._$AM._$AU
...
const Gt = Vt(class extends jt {
        constructor(t) {
            var e;
            if (super(t), t.type !== Bt.ATTRIBUTE || "class" !== t.name || (
                null === (e = t.strings) || void 0 === e
                    ? void 0
                    : e.length
            ) > 2) 
                throw Error(
                    "`classMap()` can only be used in the `class` attribute and must be the only pa" +
                    "rt in the attribute."
                )
        }
        render(t) {
        ...
        update(t, [e]) {
            ...
            if (void 0 === this.it) {
                this.it = new Set,
                void 0 !== t.strings && (
                    this.nt = new Set(t.strings.join(" ").split(/\s/).filter((t => "" !== t)))
                );
                for (const t in e) 
                    e[t] && !(
    ...
    Wt = Vt(class extends jt {
        constructor(t) {
            var e;
            if (super(t), t.type !== Bt.ATTRIBUTE || "style" !== t.name || (
                null === (e = t.strings) || void 0 === e
                    ? void 0
                    : e.length
            ) > 2) 
                throw Error(
                    "The `styleMap` directive must be used in the `style` attribute and must be the" +
                    " only part in the attribute."
                )
        }
        render(t) {
            return Object
...
class Yt extends It {
    ...
    render() {
        ...
        <div class="mdc-ripple-surface mdc-ripple-upgraded ${Gt(i)}"
          style="${Wt({
            ...
            "--mdc-ripple-top": this.topPos})}"></div>`
        }}
    ...
    class ee extends ct {
        ...
        renderRipple() {
            ...
            return this.shouldRenderRipple
                ? V `<mwc-ripple class="ripple" .primary="${ !t}" .disabled="${this.disabled}"></mwc-ripple>`
                : ""
        }
        focus() {
        ...
        getRenderClasses() {
            return {"mdc-button--raised": this.raised, "mdc-button--unelevated": this.unelevated, "mdc-button--outlined": this.outlined, "mdc-button--dense": this.dense}
        }
        render() {
            return V `
      <button
    ...
    <mwc-icon class="mdc-button__icon">
      ${this.icon}
        ...
        o([
            Jt,
            ht({type: String, attribute: "aria-haspopup"})
    ...
    `
                        ...
                        return re(i, [
                            {
                                ...
                                value: function () {
                                    ...
                                    this
                                        ._observer
                                        .observe(this._document.body || this._document.documentElement, {
                                            attributes: !0,
                                            subtree: !0,
                                            childList: !0
                                        })
        ...
        var pe = function (t) {
            ...
            o.prototype.init = function () {
                this
                    .adapter
                    .hasClass(se.STACKED) && this.setAutoStackButtons(!1),
                this.isFullscreen = this
                    .adapter
                    .hasClass(se.FULLSCREEN)
            },
            o.prototype.destroy = function () {
                this.animationTimer && (
                ...
                this.isFullscreen && this
                    .adapter
                    .deregisterContentEventHandler("scroll", this.contentScrollHandler),
                this
                    .animFrame
                    .cancelAll(),
                this
                    .adapter
                    .deregisterWindowEventHandler("resize", this.windowResizeHandler),
                this
                    .adapter
            ...
            o.prototype.open = function (t) {
                ...
                this.isFullscreen && this
                    .adapter
                    .registerContentEventHandler("scroll", this.contentScrollHandler),
                t && t.isAboveFullscreenDialog && this
                    .adapter
                    .addClass(se.SCRIM_HIDDEN),
                this
                    .adapter
                    .registerWindowEventHandler("resize", this.windowResizeHandler),
                this
                    .adapter
                ...
                this.runNextAnimationFrame((function () {
                    ...
                    e
                        .adapter
                        .addBodyClass(se.SCROLL_LOCK),
                    e.layout(),
                    e.animationTimer = setTimeout((function () {
                        e.handleAnimationTimerEnd(),
                        e
                            .adapter
                            .trapFocus(e.adapter.getInitialFocusEl()),
                        e
                            .adapter
                            .notifyOpened()
            ...
            o.prototype.showSurfaceScrim = function () {
                ...
                this
                    .adapter
                    .addClass(se.SURFACE_SCRIM_SHOWING),
                this.runNextAnimationFrame((function () {
                    t
                        .adapter
                        .addClass(se.SURFACE_SCRIM_SHOWN)
                }))
            },
            o.prototype.hideSurfaceScrim = function () {
                this
                    .adapter
                    .removeClass(se.SURFACE_SCRIM_SHOWN),
                this
                    .adapter
                    .addClass(se.SURFACE_SCRIM_HIDING)
            },
            o.prototype.handleSurfaceScrimTransitionEnd = function () {
                this
                    .adapter
                    .removeClass(se.SURFACE_SCRIM_HIDING),
                this
                    .adapter
                    .removeClass(se.SURFACE_SCRIM_SHOWING)
            },
            ...
            o.prototype.layout = function () {
                ...
                this
                    .animFrame
                    .request(ae.POLL_LAYOUT_CHANGE, (function () {
                        t.layoutInternal()
                    }))
            },
            ...
            o.prototype.handleKeydown = function (t) {
                ...
                if (e && !this.adapter.getActionFromEvent(t)) {
                    var i = t.composedPath
                            ? t.composedPath()[0]
                            : t.target,
                        o = !this.suppressDefaultPressSelector || !this
                            .adapter
                            .eventTargetMatches(i, this.suppressDefaultPressSelector);
                    e && o && this
                        .adapter
                        .clickDefaultButton()
                }
            ...
            o.prototype.handleDocumentKeydown = function (t) {
                ("Escape" === t.key || 27 === t.keyCode) && "" !== this.escapeKeyAction && this.close(
            ...
            o.prototype.handleScrollEvent = function () {
                ...
                this
                    .animFrame
                    .request(ae.POLL_SCROLL_POS, (function () {
            ...
            o.prototype.toggleScrollableClasses = function () {
                this
                    .adapter
                    .removeClass(se.SCROLLABLE),
                this
                    .adapter
                    .isContentScrollable() && (
                        this.adapter.addClass(se.SCROLLABLE),
                        this.isFullscreen && (this.toggleScrollDividerHeader(), this.toggleScrollDividerFooter())
                    )
            },
            o.prototype.toggleScrollDividerHeader = function () {
                this
                    ...
                    .isScrollableContentAtTop()
                        ? this
                            .adapter
                            .hasClass(se.SCROLL_DIVIDER_HEADER) && this
                            .adapter
                            .removeClass(se.SCROLL_DIVIDER_HEADER)
                        : this
                            .adapter
                            .addClass(se.SCROLL_DIVIDER_HEADER)
            },
            o.prototype.toggleScrollDividerFooter = function () {
                this
                    ...
                    .isScrollableContentAtBottom()
                        ? this
                            .adapter
                            .hasClass(se.SCROLL_DIVIDER_FOOTER) && this
                            .adapter
                            .removeClass(se.SCROLL_DIVIDER_FOOTER)
                        : this
                            .adapter
                            .addClass(se.SCROLL_DIVIDER_FOOTER)
            },
            o
        }(Nt);
        function ue(t) {
            ...
            !!function (t) {
                ...
                try {
                    ...
                    t
                        .document
                        .addEventListener("test", o, i),
                    t
                        .document
                        .removeEventListener("test", o, i)
                } catch (t) {
                    e = !1
                }
                return e
        ...
        class fe extends It {
            ...
            set suppressDefaultPressSelector(t) {
                this.mdcFoundation
                    ? this
                        .mdcFoundation
                        .setSuppressDefaultPressSelector(t)
    ...
    <div class="mdc-dialog ${Gt(t)}"
      ...
      <h2 id="title" class="mdc-dialog__title">${this.heading}</h2>`
            ...
            firstUpdated() {
                ...
                this.boundHandleClick = this
                    .mdcFoundation
                    .handleClick
                    .bind(this.mdcFoundation),
                this.boundHandleKeydown = this
                    .mdcFoundation
                    .handleKeydown
                    .bind(this.mdcFoundation),
                this.boundHandleDocumentKeydown = this
                    .mdcFoundation
            ...
            connectedCallback() {
                super.connectedCallback(),
                this.open && this.mdcFoundation && !this
                    .mdcFoundation
                    .isOpen() && (this.setEventListeners(), this.mdcFoundation.open())
            }
            disconnectedCallback() {
                super.disconnectedCallback(),
                this.open && this.mdcFoundation && (
            ...
            setEventListeners() {
                ...
                this.boundHandleKeydown && this
                    .mdcRoot
                    .addEventListener("keydown", this.boundHandleKeydown, ue()),
                this.boundHandleDocumentKeydown && document.addEventListener(
                    "keydown",
            ...
            removeEventListeners() {
                ...
                this.boundHandleDocumentKeydown && document.removeEventListener(
                    "keydown",
                    this.boundHandleDocumentKeydown
                )
            }
        ...
        o([
            ...
            me((function (t) {
                this.mdcFoundation && this.isConnected && (
                    t
